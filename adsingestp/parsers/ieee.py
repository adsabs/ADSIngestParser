...
class IEEEAffils(object):
    ...
    def parse(self, article_metadata):
        ...
        # IEEE puts author data in <contrib-group>, giving individual authors in each <contrib>
...
class IEEEParser(BaseBeautifulSoupParser):
    ...
    def parse(self, text, bsparser="lxml-xml"):
        ...
        # If a conference
        # IEEE IEEE for conferences contains 2 container elements about the conference:
